...
@layer ds.theme.size-mode {
  ...
  [data-size] {
    ...
    --ds-size-mode-font-size: var(
        --ds-size--sm,
        var(--ds-size-mode-font-size--sm)
      )
...
@layer ds.theme.type-scale {
  :root,
  [data-size] {
    --_ds-font-size-factor: calc(
      var(--ds-size-mode-font-size) / (var(--ds-size-base) / 16)
    );
    ...
    @supports (width: round(down, 0.1em, 1px)) {
      ...
      --ds-font-size-2: round(
        calc(0.875rem * var(--_ds-font-size-factor)),
        1px
      );
      --ds-font-size-3: round(calc(1rem * var(--_ds-font-size-factor)), 1px);
      --ds-font-size-4: round(
        calc(1.125rem * var(--_ds-font-size-factor)),
        1px
      );
      --ds-font-size-5: round(
        calc(1.3125rem * var(--_ds-font-size-factor)),
        1px
      );
      --ds-font-size-6: round(calc(1.5rem * var(--_ds-font-size-factor)), 1px);
      --ds-font-size-7: round(
        calc(1.875rem * var(--_ds-font-size-factor)),
        1px
      );
      ...
      --ds-font-size-10: round(
        calc(3.75rem * var(--_ds-font-size-factor)),
        1px
      );
    }
  }
...
<Card className={styles.customCard} style={{ padding: "20px" }}>
  <CardBlock>
    <Heading level={2} className={styles.customHeading}>
      Title
    </Heading>
  </CardBlock>
</Card>
...
<div style={{ display: "grid", gap: "var(--ds-size-4)" }}>
  <Card>
    <CardBlock>Card 1</CardBlock>
  </Card>
  <Card>
    <CardBlock>Card 2</CardBlock>
  </Card>
</div>
```
